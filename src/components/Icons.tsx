...
// Shared spin keyframes constant
...
export function SidebarIcon({ collapsed, color }: { collapsed: boolean; color: string }) {
  return (
...
export function ImportIcon({ spinning = false, color }: { spinning?: boolean; color: string }) {
  return (
...
export function ExportIcon({ spinning = false, color }: { spinning?: boolean; color: string }) {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
      style={{ animation: spinning ? "spin 0.9s linear infinite" : "none" }}>
      <style>{SPIN_CSS}</style>
...
export function SearchIcon({ color, style }: { color: string; style?: React.CSSProperties }) {
  return (
...
export function ChevronRightIcon({ color, size = 14 }: { color: string; size?: number }) {
  return (
...
export function DocIcon({ color, size = 14 }: { color: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function GlobeIcon({ color, size = 14 }: { color: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SyncIcon({ spinning, color, small = false }: { spinning: boolean; color: string; small?: boolean }) {
...
// SpinnerIcon is SyncIcon with size 16, always spinning
